            ...
            <table className="w-full text-xs">
                <thead className="sticky top-0 z-10 bg-card">
                    <tr className="border-border border-b">
                        ...
                        <th className="px-2 py-2 text-center text-[10px] text-muted-foreground uppercase tracking-wider">
                            Level
                        </th>
                ...
                <tbody>
                    {props.items.map((logItem) => (
                        ...
                        >
                            <td className="whitespace-nowrap px-3 py-1 font-mono text-terminal-dim">
                            ...
                            <td className="px-2 py-1 font-mono text-terminal-dim">
                                {getTargetLabel(logItem)}
                            </td>
                            <td className="max-w-64 truncate px-2 py-1 text-secondary-foreground">
                                {logItem.message}
                            </td>
                            <td className="px-2 py-1 font-mono text-terminal-dim">
