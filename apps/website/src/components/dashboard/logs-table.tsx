            ...
            <table className="w-full text-xs">
                <thead className="sticky top-0 z-10 bg-card">
                    <tr className="border-border border-b">
                        <th className="w-px whitespace-nowrap px-3 py-2 text-left text-[10px] text-muted-foreground uppercase tracking-wider">
                            Time
                        </th>
                        <th className="w-px whitespace-nowrap px-2 py-2 text-left text-[10px] text-muted-foreground uppercase tracking-wider">
                            Level
                        </th>
                        <th className="px-2 py-2 text-left text-[10px] text-muted-foreground uppercase tracking-wider">
                            Action
                        </th>
                        <th className="w-px whitespace-nowrap px-2 py-2 text-right text-[10px] text-muted-foreground uppercase tracking-wider">
                            Type
                        </th>
                        <th className="w-px whitespace-nowrap px-2 py-2 text-right text-[10px] text-muted-foreground uppercase tracking-wider">
                            Target
                ...
                <tbody>
                    {props.items.map((logItem) => (
                        ...
                        >
                            <td className="w-px whitespace-nowrap px-3 py-1 font-mono text-terminal-dim">
                            ...
                            <td className="w-px whitespace-nowrap px-2 py-1 text-right">
                                <PrimitiveTypeBadge type={logItem.primitiveType} />
                            </td>
                            <td className="w-px whitespace-nowrap px-2 py-1 text-right font-mono text-terminal-dim">
                                {getTargetLabel(logItem)}
                            </td>
                            <td className="max-w-64 truncate px-2 py-1 text-right text-secondary-foreground">
                                {logItem.message}
                            </td>
                            <td className="w-px whitespace-nowrap px-2 py-1 text-right font-mono text-terminal-dim">
