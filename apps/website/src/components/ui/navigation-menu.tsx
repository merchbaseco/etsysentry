...
function NavigationMenuList({ className, ...props }: ComponentProps<typeof List>) {
    return (
        <List
            className={cn(
...
function NavigationMenuItem({ className, ...props }: ComponentProps<typeof Item>) {
    return (
        <Item className={cn('relative', className)} data-slot="navigation-menu-item" {...props} />
    );
}
...
function NavigationMenuTrigger({ className, children, ...props }: ComponentProps<typeof Trigger>) {
    return (
        <Trigger
...
function NavigationMenuContent({ className, ...props }: ComponentProps<typeof Content>) {
    return (
        <Content
            className={cn(
...
function NavigationMenuViewport({ className, ...props }: ComponentProps<typeof Viewport>) {
    return (
...
function NavigationMenuLink({ className, ...props }: ComponentProps<typeof Link>) {
    return (
        <Link
            className={cn(
